...
int main()
{
    ...
    v1.push_back(1); v1.push_back(0); v1.push_back(1); v1.push_back(1); v1.push_back(1); //10111
    v2.push_back(1); v2.push_back(0); v2.push_back(1); v2.push_back(0); v2.push_back(1); //10101
    v3.push_back(1); v3.push_back(0); v3.push_back(1); v3.push_back(1); v3.push_back(1); //10111
    v4.push_back(1); v4.push_back(1); v4.push_back(1); v4.push_back(0); v4.push_back(1); //11101
    v5.push_back(0); v5.push_back(0); v5.push_back(0); v5.push_back(0); v5.push_back(1); //00001
